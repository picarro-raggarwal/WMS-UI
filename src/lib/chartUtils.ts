...
export const getGradientColorClassName = (color: AvailableChartColorsKeys): string => {
...
): [number | "auto" | undefined, number | "auto" | undefined] => {
  return [autoMinValue ? "auto" : minValue ?? 0, maxValue ?? "auto"];
};

// Tremor Raw hasOnlyOneValueForKey [v0.1.0]

export const hasOnlyOneValueForKey = (data: Record<string, any>[], key: string) => {

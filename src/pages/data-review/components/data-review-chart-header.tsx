...
const StatsBar = ({
  ...
  return (
    <div className="flex items-center gap-6 bg-white dark:bg-neutral-800 -m-6 mb-4 px-4 py-5 !pb-3 border-neutral-200 dark:border-neutral-700 border-b border-dashed rounded-t-xl">
      <Button
        variant="ghost"
      ...
      <div className="flex grow justify-between items-center gap-6 pl-6 border-neutral-200 dark:border-neutral-700 border-l border-dashed divide-x divide-dashed divide-neutral-200 dark:divide-neutral-700 tabular-nums dark:text-neutral-300 text-sm">
        {currentValue ? (
        ...
        {mean ? (
          <div className={`flex flex-col items-start ${currentValue ? "pl-6" : "pl-0"}`}>
        ...
        {thresholds ? (
          <>
            <Button
              ...
              className="flex flex-col items-start pl-6 !h-full">
              <span className="flex flex-col items-start">

  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "items-start gap-1.5 grid bg-white dark:bg-neutral-950 shadow-xl px-2.5 py-1.5 border border-neutral-200 border-neutral-200/50 dark:border-neutral-800 dark:border-neutral-800/50 rounded-lg min-w-[8rem] text-xs",
          className
        )}
      >
          ...
          {payload.map((item, index) => {
            ...
            return (
              <div
                key={item.dataKey}
                className={cn(
                  "flex flex-wrap items-stretch gap-2 w-full [&>svg]:w-2.5 [&>svg]:h-2.5 [&>svg]:text-neutral-500 dark:[&>svg]:text-neutral-400",
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={cn(
                            "bg-[--color-bg] border-[--color-border] rounded-[2px] shrink-0",
                            {
        ...
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value}
              className={cn(
                "flex items-center gap-1.5 [&>svg]:w-3 [&>svg]:h-3 [&>svg]:text-neutral-500 dark:[&>svg]:text-neutral-400"
              )}
            >

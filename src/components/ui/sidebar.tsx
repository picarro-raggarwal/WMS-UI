...
>(
  (
    ...
    const [openedSidebarStateLocalStorage, setOpenedSidebarStateLocalStorage] =
      useLocalStorage({
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        const openState =
          typeof value === "function"
            ? value(openedSidebarStateLocalStorage)
            : value;
        if (setOpenProp) {
      ...
      [
        setOpenProp,
        openedSidebarStateLocalStorage,
        setOpenedSidebarStateLocalStorage
      ]
    );
...
>(
  (
    ...
    const { isMobile, state, openMobile, setOpenMobile, isHydrated } =
      useSidebar();
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex flex-col bg-sidebar w-[--sidebar-width] h-full text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative bg-transparent w-[--sidebar-width] h-svh duration-0 ease-linear",
        ...
        <div
          className={cn(
            "hidden z-10 fixed inset-y-0 md:flex w-[--sidebar-width] h-svh duration-0 ease-linear",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeft className="size-5 dark:text-neutral-400" />
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex flex-col flex-1 bg-neutral-50 dark:bg-neutral-900 rounded-tl-xl min-h-svh",
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "bg-white dark:bg-neutral-800 shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring w-full h-8",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex flex-col px-4 py-4 w-full min-w-0",
        className
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex items-center px-2 rounded-md outline-none ring-sidebar-ring focus-visible:ring-2 h-8 [&>svg]:size-4 font-medium text-sidebar-foreground/70 text-xs ease-linear shrink-0 [&>svg]:shrink-0",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex items-center gap-2 data-[active=true]:bg-neutral-800 hover:bg-neutral-800 aria-disabled:opacity-50 disabled:opacity-50 data-[active=true]:shadow-lg p-4 group-data-[collapsible=icon]:!px-3.5 !py-5 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 rounded-lg outline-none ring-sidebar-ring focus-visible:ring-2 w-full group-data-[collapsible=icon]:!w-12 group-data-[collapsible=icon]:!h-9 [&>svg]:size-[1.15rem] overflow-hidden font-normal text-neutral-400 data-[active=true]:text-white data-[state=open]:hover:text-white hover:text-white text-sm text-left [&>span:last-child]:truncate transition-[width,height,padding] aria-disabled:pointer-events-none disabled:pointer-events-none [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: " ",
